...
function (install_imported TY)
    ...
    foreach (target ${ARG_TARGETS})
        ...
        if (NOT ${type} STREQUAL "${TY}_LIBRARY")
        ...
        set (name_noversion "${CMAKE_${TY}_LIBRARY_PREFIX}${output_name}${CMAKE_${TY}_LIBRARY_SUFFIX}")

        if (APPLE)
            set (name_version "${CMAKE_${TY}_LIBRARY_PREFIX}${output_name}${version}${CMAKE_${TY}_LIBRARY_SUFFIX}")
            set (name_soversion "${CMAKE_${TY}_LIBRARY_PREFIX}${output_name}${soversion}${CMAKE_${TY}_LIBRARY_SUFFIX}")
        else ()
            set (name_version "${CMAKE_${TY}_LIBRARY_PREFIX}${output_name}${CMAKE_${TY}_LIBRARY_SUFFIX}${version}")
            set (name_soversion "${CMAKE_${TY}_LIBRARY_PREFIX}${output_name}${CMAKE_${TY}_LIBRARY_SUFFIX}${soversion}")
        endif ()
