...
function (install_imported)
    ...
    foreach (target ${ARG_TARGETS})
        ...
        set (name_noversion "${CMAKE_STATIC_LIBRARY_PREFIX}${output_name}${CMAKE_STATIC_LIBRARY_SUFFIX}")

        if (APPLE)
            set (name_version "${CMAKE_SHARED_LIBRARY_PREFIX}${output_name}${version}${CMAKE_${TY}_LIBRARY_SUFFIX}")
            set (name_soversion "${CMAKE_SHARED_LIBRARY_PREFIX}${output_name}${soversion}${CMAKE_${TY}_LIBRARY_SUFFIX}")
        else ()
          set (name_version "${CMAKE_Static_LIBRARY_PREFIX}${output_name}${CMAKE_STATIC_LIBRARY_SUFFIX}${version}")
            set (name_soversion "${CMAKE_STATIC_LIBRARY_PREFIX}${output_name}${CMAKE_STATIC_LIBRARY_SUFFIX}${soversion}")
        endif ()
